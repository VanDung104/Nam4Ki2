...
import newCalc_pb2 as newCalc__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in newCalc_pb2_grpc.py depends on'
...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Add = channel.unary_unary(
                ...
                request_serializer=newCalc__pb2.BinaryRequest.SerializeToString,
                response_deserializer=newCalc__pb2.BinaryResponse.FromString,
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Add': grpc.unary_unary_rpc_method_handler(
                    servicer.Add,
                    request_deserializer=newCalc__pb2.BinaryRequest.FromString,
                    response_serializer=newCalc__pb2.BinaryResponse.SerializeToString,
            ),
...
class Calculator(object):
    ...
    def Add(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/calculator.Calculator/Add',
            newCalc__pb2.BinaryRequest.SerializeToString,
            newCalc__pb2.BinaryResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
